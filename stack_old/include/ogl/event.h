...
enum { oglSpecial=0x80 }; // start of special key names
enum { oglSpecialF=oglSpecial }; // F keys, e.g., F3 is oglSpecialF+3
enum {  // arrow keys
	oglSpecialLeft=oglSpecial+GLUT_KEY_LEFT,
	oglSpecialUp,
	oglSpecialRight,
	oglSpecialDown,
	oglSpecialPageUp,
...
bool oglButtonOnce(int butNo,const char *what);
...
extern toggle_t oglKeyMap; ///< key is currently down
extern toggle_t oglToggles; ///< key toggles this value (starts off)
