/**
 A 2x2 column-oriented matrix type suspiciously similar 
 to GLSL's "mat2".
...
/** A mat2 is really just an array of 2 column vectors.
	mat2 m;
...
inline mat2 operator*(const mat2::real &L,mat2 R) {
	R*=L;
	return R;
}
